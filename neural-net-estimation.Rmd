...
model = keras.Sequential([
  layers.Dense(40, activation='relu', input_shape=[len(r.train_dataset.keys())]),
...
model.compile(loss="mse",
              optimizer=tf.keras.optimizers.SGD(lr=1e-4, momentum=0.6)) 
...
```{python}
# model = keras.models.load_model("python_model_1.h5")
