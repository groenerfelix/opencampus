...
write.csv(gefuehlteTemp, "gefuehlte_Temperatur.csv")
```
...
kielmachtauf<- dplyr::select(umsatz, Kielmachtauf, Datum)

write.csv(kielmachtauf, "kielmachtauf.csv")
```
...
flohmarkt<- dplyr::select(umsatz, flohmarkt,Datum)
write.csv(flohmarkt, "flohmarkt.csv")
```
