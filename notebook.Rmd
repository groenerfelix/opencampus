...
---
To-Do:
- Pattis, Finns und weitere Daten einbinden. Weitere Feiertage verwenden.
...
```{r, message=FALSE}
neues_datum <- data.frame(Datum = seq.Date(from = as.Date("2019-06-04"), to = as.Date("2019-12-31"), by = "day"))
